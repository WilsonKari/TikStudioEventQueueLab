> Documento histórico congelado.
>
> Conserva el contexto acumulado hasta el baseline `8afa3b6`.
> No representa por sí solo el estado operativo actual.
> La referencia autoritativa vigente es `/PROJECT_CONTEXT.md`.
